...
def train_model(selected_learning_rate):
    ...
    main_dir = rf"E:/NLPProject/experiments/{current_model}_il{str(max_input_length)}_bs{str(batch_size)}_as{accumulation_steps}_ol{str(generation_max_length)}_ts{training_samples}/{str(selected_learning_rate)}"
